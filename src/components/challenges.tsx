...
export default function Challenges() {
    ...
    return (
        <div className='min-h-screen flex flex-col items-center justify-center p-8 gap-3 bg-secondary'>
            <h1 className='scroll-m-20 text-6xl text-center font-extrabold tracking-tight sm:text-7xl lg:text-9xl bg-clip-text bg-gradient-to-tl from-blue-600 to-violet-600 text-transparent'>Challenges</h1>
            <p className="mt-5 text-lg text-center text-muted-foreground">Choose your field, accept the challenge and get the trophy.</p>
