...
export default function Challenges() {
    ...
    const challenges=[
        ...
        },
        {
            ...
            description: (<p>Develop an MVP for a peer-to-peer platform that connects Indian college students with mentors, industry experts, and potential employers. It should include tools for students to showcase their skills and connect with potential employers. The platform should be user-friendly, accessible on web and mobile, scalable, and prioritise creative ideas to improve students education and career prospects.<br /><br />Challenge by <a href="https://i2c2.tech"><b>I2C2 Team</b></a></p>),
